...
export const Landing = () => {
    ...
    <div>
        ...
        <div className="flex gap-10 mt-10">
            <input
                style={{"width" : "100%"}}
                className="text-black bg-gray-50 text-xl text-center border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 block p-1 dark:border-gray-600 dark:placeholder-gray-400 dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500"
